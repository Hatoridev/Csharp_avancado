...
2. O método `Retorno` retorna uma string formatada com os valores dos campos `Nome`, `Idade` e `Serie`.
...
4. O método `RetornoConsole` chama o método `Retorno` e imprime o resultado no console usando `Console.WriteLine`.
